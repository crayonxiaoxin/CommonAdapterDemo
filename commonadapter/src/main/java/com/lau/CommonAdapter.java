...
public abstract class CommonAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private setOnItemLongClickListener itemLongClickListener;
     ...
     * @param recyclerView
     */
    public CommonAdapter(Context context, List<T> list, int layoutId, RecyclerView recyclerView) {
        this.context = context;
        this.list = list;
        this.layoutId = layoutId;
            ...
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (itemLongClickListener != null) {
                        itemLongClickListener.onItemLongClick(realPosition);
                        return true;
                    } else {
                        return false;
                    }
    ...
    public void setOnItemLongClickListener(setOnItemLongClickListener listener) {
